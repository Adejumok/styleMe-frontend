...
function SignUpForm() {
  ...
  const googleSignUpClick = () => {
    ...
    const oauth2Url = `https://accounts.google.com/o/oauth2/auth?client_id=${googleClientId}&redirect_uri=${encodeURIComponent(
      "http://localhost:3000/auth/google/callback"
    )}&response_type=token&scope=https://www.googleapis.com/auth/cloud-platform`;
